-- | Based on code from hxt-css (Text.XML.HXT.CSS.Parser)
...
safeParseSelector :: String -> Either String SelectorsGroup
safeParseSelector s =
...
-- selector.
parseSelector :: String -> SelectorsGroup
parseSelector = either error id . safeParseSelector
